...
if __name__ == "__main__":
    ...
    for filename in os.listdir(directory):
        if filename.endswith(".txt"):
            K_lst = read_one_txt_for_path(directory + "/" + filename)  # The k value between all city pairs in a time slice
            K_min = min(K_lst)  # The minimum value of k between all city pairs in a time slice
